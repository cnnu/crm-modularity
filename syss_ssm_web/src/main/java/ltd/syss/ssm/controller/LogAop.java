...
public class LogAop {
    ...
    private Date starTime; // 访问时间
    private Class executionClass;;// 访问的类
    private Method executionMethod; // 访问的方法
    // 主要获取访问时间、访问的类、访问的方法

    @Before("execution(* ltd.syss.ssm.controller.*.*(..))")
    ...
    @After("execution(* ltd.syss.ssm.controller.*.*(..))")
        ...
        if (executionClass != SysLogController.class){
            ...
            if (classAnnotation != null) {
                ...
                if (methodAnnotation != null) {
                    ...
                    // 获取访问时长
                    long executionTime = new Date().getTime() - starTime.getTime();
                    // 将sysLog对象属性封装
